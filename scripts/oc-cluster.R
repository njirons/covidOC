...
state.num <- as.integer(args[1]) # US state
cost.setting <- as.character(args[2]) # cost function parameter specification
nX <- as.integer(args[3]) # model with nX confounders
